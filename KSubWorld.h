...
public:	
	...
	int			m_ClientRegionIdx[9];//MAX_REGION
...
public:
	...
	void        GetFreePos(POINT& pos);//POINT&
	void        GetFreeNewObjPos(POINT& pos);//POINT&
	
	BOOL		CanPutObj(POINT pos,int nModle=0,BOOL nIsCheckNpc=FALSE);//POINT
